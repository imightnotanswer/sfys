    ...
    return (
        <nav className="w-full mt-4">
            <div className="flex items-center justify-center gap-x-4">
                <Link
                    href="/"
                    className={`text-[clamp(20px,3vw,24px)] font-[RideSlow] tracking-[0.1em] transition-colors ${isActive('/') ? 'text-[#e43720]' : 'hover:text-[#e43720]'}`}
                >
                    HOME
                </Link>
                <Link
                    href="/about"
                    className={`text-[clamp(20px,3vw,24px)] font-[RideSlow] tracking-[0.1em] transition-colors ${isActive('/about') ? 'text-[#e43720]' : 'hover:text-[#e43720]'}`}
                >
                    ABOUT
                </Link>
                <Link
                    href="/contact"
                    className={`text-[clamp(20px,3vw,24px)] font-[RideSlow] tracking-[0.1em] transition-colors ${isActive('/contact') ? 'text-[#e43720]' : 'hover:text-[#e43720]'}`}
                >
                    CONTACT
                </Link>
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[clamp(20px,3vw,24px)] font-[RideSlow] tracking-[0.1em] hover:text-[#e43720] transition-colors"
                >
                    HOTEL
                </a>
            </div>
